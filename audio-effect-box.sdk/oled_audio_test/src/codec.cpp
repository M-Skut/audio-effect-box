...
void Codec::init_codec(){
	reset_adau1761();
	init_adau1761();
}

void Codec::write_adau1761(uint32_t addr, uint64_t data, uint32_t nbytes) {
    uint32_t busy;
...
uint64_t Codec::read_adau1761(uint32_t addr, uint32_t nbytes) {
    uint32_t busy;
...
void Codec::reset_adau1761(void) {
