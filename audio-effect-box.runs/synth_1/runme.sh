...
HD_PWD='/home/maniek/Vivado/audio-effect-box/audio-effect-box.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_processing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_processing_wrapper.tcl
