...
HD_PWD='/home/maniek/Vivado/audio-effect-box/audio-effect-box.runs/audio_processing_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_processing_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_processing_axi_gpio_0_1.tcl
