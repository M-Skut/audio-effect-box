...
HD_PWD='/home/maniek/Vivado/audio-effect-box/audio-effect-box.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_processing_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source audio_processing_wrapper.tcl -notrace
