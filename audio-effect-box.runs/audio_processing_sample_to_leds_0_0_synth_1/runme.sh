...
HD_PWD='/home/maniek/Vivado/audio-effect-box/audio-effect-box.runs/audio_processing_sample_to_leds_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_processing_sample_to_leds_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_processing_sample_to_leds_0_0.tcl
